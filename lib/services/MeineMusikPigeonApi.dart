...
class AudioFile {
  ...
  List<Object?> _toList() {
    return <Object?>[id, path, sizeInBytes, title, artist, album, trackNumber, durationInMilliseconds];
  }
  ...
  static AudioFile decode(Object result) {
  ...
  bool operator ==(Object other) {
    if (other is! AudioFile || other.runtimeType != runtimeType) {
      return false;
    }
...
class _PigeonCodec extends StandardMessageCodec {
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      case 129:
        return AudioFile.decode(readValue(buffer)!);
      default:
...
class MeineMusikNativeMethods {
  ...
  Future<String> getAppVersion() async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.meine_musik.MeineMusikNativeMethods.getAppVersion$pigeonVar_messageChannelSuffix';
  ...
  Future<int> getApiLevel() async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.meine_musik.MeineMusikNativeMethods.getApiLevel$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<List<AudioFile>> findAll() async {
    ...
    if (pigeonVar_replyList == null) {
      ...
      return (pigeonVar_replyList[0] as List<Object?>?)!.cast<AudioFile>();
    }
  }
