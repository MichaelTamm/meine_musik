...
void main() {
  test('$MusicBrainz.searchReleaseByAlbum', () async {
    ...
    final song3 = anAudioFile(id: 3, artist: 'No Angels', title: 'Promises Can Wait', album: 'Elle´ments', trackNumber: 3);
    final album = Album.fromNameAndSongs('Elle´ments', [song1, song2, song3]);
