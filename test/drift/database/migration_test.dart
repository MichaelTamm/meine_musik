...
void main() {
  ...
  test('migration from v1 to v2 does not corrupt data', () async {
    ...
    final oldPlaylistItemsData = <v1.PlaylistItemsData>[];
    final expectedNewPlaylistItemsData = <v2.PlaylistItemsData>[];
    ...
    await verifier.testWithDataIntegrity(
      ...
      createItems: (batch, oldDb) {
        ...
        batch.insertAll(oldDb.playlistItems, oldPlaylistItemsData);
      },
      validateItems: (newDb) async {
        ...
        expect(
          expectedNewPlaylistItemsData,
          await newDb.select(newDb.playlistItems).get(),
        );
      },
    );
  });
